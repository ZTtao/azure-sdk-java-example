...
/**
 * Created by chen.rui on 5/31/2016.
 */
public class SASStaorageTest {

    public static void main(String[] args) throws Exception {
        InputStream inputStream = SASStaorageTest.downloadFile("https://kevinstorage1.blob.core.chinacloudapi.cn/test/test.ps1", "test");
